 ...
 */
 abstract class GalleryActivity<T : BaseContract.BasePresenter, T2 : ViewDataBinding>:BaseActivity<T,T2>() , TakePhoto.TakeResultListener, InvokeListener, TakePhotoinf {

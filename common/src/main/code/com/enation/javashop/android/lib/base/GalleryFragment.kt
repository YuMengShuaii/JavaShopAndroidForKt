 ...
 */
 abstract class GalleryFragment<T : BaseContract.BasePresenter, T2 : ViewDataBinding> : BaseFragment<T,T2>(), TakePhoto.TakeResultListener, InvokeListener, TakePhotoinf {
